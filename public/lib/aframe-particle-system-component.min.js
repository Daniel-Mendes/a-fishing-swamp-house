(() => {
  var e = {
      544: (e, t, r) => {
        ...
        void 0 ===
          (a = "function" == typeof (i = s) ? i.call(t, r, t, e) : i) ||
          (e.exports = a),
          (s.TypedArrayHelper = function (e, t, r, i) {
            "use strict";
          ...
          (s.TypedArrayHelper.constructor = s.TypedArrayHelper),
          (s.TypedArrayHelper.prototype.setSize = function (e, t) {
            "use strict";
          ...
          (s.TypedArrayHelper.prototype.shrink = function (e) {
            "use strict";
            return (
              (this.array = this.array.subarray(0, e)), (this.size = e), this
            );
          }),
          (s.TypedArrayHelper.prototype.grow = function (e) {
            "use strict";
            var t = this.array,
              r = new this.TypedArrayConstructor(e);
            return r.set(t), (this.array = r), (this.size = e), this;
          }),
          (s.TypedArrayHelper.prototype.splice = function (e, t) {
            "use strict";
            (e *= this.componentSize), (t *= this.componentSize);
            for (var r = [], i = this.array, a = i.length, s = 0; s < a; ++s)
              (s < e || s >= t) && r.push(i[s]);
            return this.setFromArray(0, r), this;
          }),
          (s.TypedArrayHelper.prototype.setFromArray = function (e, t) {
            "use strict";
            var r = e + t.length;
            return (
              r > this.array.length
                ? this.grow(r)
                : r < this.array.length && this.shrink(r),
              this.array.set(t, this.indexOffset + e),
              this
            );
          }),
          (s.TypedArrayHelper.prototype.setVec2 = function (e, t) {
            "use strict";
            return this.setVec2Components(e, t.x, t.y);
          }),
          (s.TypedArrayHelper.prototype.setVec2Components = function (e, t, r) {
            "use strict";
            var i = this.array,
              a = this.indexOffset + e * this.componentSize;
            return (i[a] = t), (i[a + 1] = r), this;
          }),
          (s.TypedArrayHelper.prototype.setVec3 = function (e, t) {
            "use strict";
            return this.setVec3Components(e, t.x, t.y, t.z);
          }),
          (s.TypedArrayHelper.prototype.setVec3Components = function (
            e,
            t,
            r,
            i
            ...
            return (a[s] = t), (a[s + 1] = r), (a[s + 2] = i), this;
          }),
          (s.TypedArrayHelper.prototype.setVec4 = function (e, t) {
            "use strict";
            return this.setVec4Components(e, t.x, t.y, t.z, t.w);
          }),
          (s.TypedArrayHelper.prototype.setVec4Components = function (
            e,
            t,
            r,
            i,
            ...
            return (
              (s[o] = t), (s[o + 1] = r), (s[o + 2] = i), (s[o + 3] = a), this
            );
          }),
          (s.TypedArrayHelper.prototype.setMat3 = function (e, t) {
            "use strict";
          ...
          (s.TypedArrayHelper.prototype.setMat4 = function (e, t) {
            "use strict";
            return this.setFromArray(
              this.indexOffset + e * this.componentSize,
              t.elements
          ...
          (s.TypedArrayHelper.prototype.setColor = function (e, t) {
            "use strict";
            return this.setVec3Components(e, t.r, t.g, t.b);
          }),
          (s.TypedArrayHelper.prototype.setNumber = function (e, t) {
            "use strict";
            return (
              (this.array[this.indexOffset + e * this.componentSize] = t), this
            );
          }),
          (s.TypedArrayHelper.prototype.getValueAtIndex = function (e) {
            "use strict";
            return this.array[this.indexOffset + e];
          }),
          (s.TypedArrayHelper.prototype.getComponentValueAtIndex = function (
            e
          ) {
            "use strict";
          ...
          (s.ShaderAttribute = function (e, t, r) {
            "use strict";
            var i = s.ShaderAttribute.typeSizeMap;
          ...
          (s.ShaderAttribute.constructor = s.ShaderAttribute),
          (s.ShaderAttribute.typeSizeMap = {
            f: 1,
            v2: 2,
            v3: 3,
            v4: 4,
          ...
          (s.ShaderAttribute.prototype.setUpdateRange = function (e, t) {
            "use strict";
          ...
          (s.ShaderAttribute.prototype.splice = function (e, t) {
            "use strict";
          ...
          (s.ShaderAttribute.prototype._ensureTypedArray = function (e) {
            "use strict";
            (null !== this.typedArray &&
              ...
              (null !== this.typedArray && this.typedArray.size !== e
                ...
                : null === this.typedArray &&
                  (this.typedArray = new s.TypedArrayHelper(
                    this.arrayType,
                    e,
                    this.componentSize
                  )));
          }),
          (s.ShaderAttribute.prototype._createBufferAttribute = function (e) {
            "use strict";
          ...
          (s.shaders = {
            vertex: [
              s.shaderChunks.defines,
              s.shaderChunks.uniforms,
              s.shaderChunks.attributes,
              s.shaderChunks.varyings,
              THREE.ShaderChunk.common,
              THREE.ShaderChunk.logdepthbuf_pars_vertex,
              THREE.ShaderChunk.fog_pars_vertex,
              s.shaderChunks.branchAvoidanceFunctions,
              s.shaderChunks.unpackColor,
              s.shaderChunks.unpackRotationAxis,
              s.shaderChunks.floatOverLifetime,
              s.shaderChunks.colorOverLifetime,
              s.shaderChunks.paramFetchingFunctions,
              s.shaderChunks.forceFetchingFunctions,
              s.shaderChunks.rotationFunctions,
              "void main() {",
          ...
          (s.utils = {
            ...
            ensureValueOverLifetimeCompliance: function (e, t, r) {
              ...
              var i = this.clamp(e._value.length, t, r),
                ...
                s = Math.max(i, a);
              e._value.length !== s &&
                (e._value = this.interpolateArray(e._value, s)),
                e._spread.length !== s &&
                  (e._spread = this.interpolateArray(e._spread, s));
            },
            interpolateArray: function (e, t) {
              ...
              for (
                ...
                var o = s * a,
                  ...
                  u = Math.ceil(o),
                  l = o - n;
                i[s] = this.lerpTypeAgnostic(e[n], e[u], l);
              }
              return (
                i.push(
                  "function" == typeof e[r - 1].clone
                    ? e[r - 1].clone()
                    : e[r - 1]
                ),
                i
            ...
            lerpTypeAgnostic: function (e, t, r) {
              ...
              return typeof e === a.NUMBER && typeof t === a.NUMBER
                ...
                ? (((i = e.clone()).x = this.lerp(e.x, t.x, r)),
                ...
                ? (((i = e.clone()).r = this.lerp(e.r, t.r, r)),
            ...
            randomVector3: function (e, t, r, i, a) {
              "use strict";
              var s = r.x + (Math.random() * i.x - 0.5 * i.x),
                o = r.y + (Math.random() * i.y - 0.5 * i.y),
                n = r.z + (Math.random() * i.z - 0.5 * i.z);
              a &&
                ((s = 0.5 * -a.x + this.roundToNearestMultiple(s, a.x)),
                (o = 0.5 * -a.y + this.roundToNearestMultiple(o, a.y)),
                (n = 0.5 * -a.z + this.roundToNearestMultiple(n, a.z))),
                e.typedArray.setVec3Components(t, s, o, n);
            },
            randomColor: function (e, t, r, i) {
              "use strict";
              var a = r.r + Math.random() * i.x,
                s = r.g + Math.random() * i.y,
                o = r.b + Math.random() * i.z;
              (a = this.clamp(a, 0, 1)),
                (s = this.clamp(s, 0, 1)),
                (o = this.clamp(o, 0, 1)),
                e.typedArray.setVec3Components(t, a, s, o);
            },
            randomColorAsHex: (function () {
              "use strict";
              var e = new THREE.Color();
              return function (t, r, i, a) {
                for (var s = i.length, o = [], n = 0; n < s; ++n) {
                  var u = a[n];
                  e.copy(i[n]),
                ...
                t.typedArray.setVec4Components(r, o[0], o[1], o[2], o[3]);
              };
            })(),
            ...
            randomVector3OnSphere: function (e, t, r, i, a, s, o, n) {
              "use strict";
              ...
              o && (c = Math.round(c / o) * o),
                ...
                (h += r.y),
                (f += r.z),
                e.typedArray.setVec3Components(t, d, h, f);
            },
            seededRandom: function (e) {
              var t = 1e4 * Math.sin(e);
              return t - (0 | t);
            },
            randomVector3OnDisc: function (e, t, r, i, a, s, o) {
              "use strict";
            ...
            randomDirectionVector3OnSphere: (function () {
              ...
              return function (t, r, i, a, s, o, n, u) {
                e.copy(o),
                  (e.x -= i),
                  (e.y -= a),
                  (e.z -= s),
            ...
            getPackedRotationAxis: (function () {
              ...
              return function (a, s) {
                return (
                  e.copy(a).normalize(),
                  t.copy(s).normalize(),
                  (e.x += 0.5 * -s.x + Math.random() * s.x),
                  (e.y += 0.5 * -s.y + Math.random() * s.y),
                  (e.z += 0.5 * -s.z + Math.random() * s.z),
          ...
          (s.Group = function (e) {
            ...
            var t = s.utils,
              r = t.types;
            ((e = t.ensureTypedArg(e, r.OBJECT, {})).texture = t.ensureTypedArg(
              e.texture,
              r.OBJECT,
              {}
            )),
              ...
              (this.textureLoop = t.ensureTypedArg(
                e.texture.loop,
                r.NUMBER,
                1
              )),
              ...
              (this.transparent = t.ensureTypedArg(
                e.transparent,
                r.BOOLEAN,
                !0
              )),
          ...
          (s.Group.constructor = s.Group),
          (s.Group.prototype._updateDefines = function () {
            "use strict";
            for (
              var e, t = this.emitters, r = t.length - 1, i = this.defines;
              r >= 0;
              --r
            )
              (e = t[r]),
            ...
            for (var s in r)
              r.hasOwnProperty(s) &&
                ...
                (t = a[s])
                  ...
                  : i.setAttribute(s, e.bufferAttribute),
                (e.bufferAttribute.needsUpdate = !0));
            this.geometry.setDrawRange(0, this.particleCount);
          }),
          (s.Group.prototype.addEmitter = function (e) {
            "use strict";
            if (e instanceof s.Emitter != 0)
              if (this.emitterIDs.indexOf(e.uuid) > -1)
                ...
                if (null === e.group) {
                  var t = this.attributes,
                    ...
                    i = r + e.particleCount;
                  for (var a in ((this.particleCount = i),
                  null !== this.maxParticleCount &&
                  ...
                  for (var o = r; o < i; ++o)
                    e._assignPositionValue(o),
                      e._assignForceValue(o, "velocity"),
                      e._assignForceValue(o, "acceleration"),
                      e._assignAbsLifetimeValue(o, "opacity"),
                      e._assignAbsLifetimeValue(o, "size"),
                      e._assignAngleValue(o),
                      e._assignRotationValue(o),
                      e._assignParamsValue(o),
                      e._assignColorValue(o);
                  return (
          ...
          (s.Group.prototype.removeEmitter = function (e) {
            "use strict";
            ...
            if (e instanceof s.Emitter != 0)
              if (-1 !== t) {
                for (
                  ...
                  (a.array[4 * o] = 0), (a.array[4 * o + 1] = 0);
                for (var n in (this.emitters.splice(t, 1),
                this.emitterIDs.splice(t, 1),
                this.attributes))
                  this.attributes.hasOwnProperty(n) &&
                    this.attributes[n].splice(r, i);
          ...
          (s.Group.prototype.getFromPool = function () {
            ...
            if (t) {
              var r = new s.Emitter(this._poolCreationSettings);
              return this.addEmitter(r), r;
            }
            return null;
          }),
          (s.Group.prototype.releaseIntoPool = function (e) {
            "use strict";
            if (e instanceof s.Emitter != 0)
          ...
          (s.Group.prototype.addPool = function (e, t, r) {
            "use strict";
            var i;
            (this._poolCreationSettings = t),
              (this._createNewWhenPoolEmpty = !!r);
            for (var a = 0; a < e; ++a)
              (i = Array.isArray(t) ? new s.Emitter(t[a]) : new s.Emitter(t)),
                this.addEmitter(i),
                this.releaseIntoPool(i);
            return this;
          }),
          (s.Group.prototype._triggerSingleEmitter = function (e) {
            "use strict";
            ...
            if (null !== t)
              return (
                e instanceof THREE.Vector3 &&
                  (t.position.value.copy(e),
                  (t.position.value = t.position.value)),
                t.enable(),
                setTimeout(function () {
                  t.disable(), r.releaseIntoPool(t);
                }, 1e3 *
                  Math.max(t.duration, t.maxAge.value + t.maxAge.spread)),
                this
              );
            console.log("SPE.Group pool ran out.");
          }),
          (s.Group.prototype.triggerPoolEmitter = function (e, t) {
            "use strict";
          ...
          (s.Group.prototype._updateUniforms = function (e) {
            "use strict";
            (this.uniforms.runTime.value += e),
          ...
          (s.Group.prototype._updateBuffers = function (e) {
            "use strict";
            for (
              var t,
                r,
              ...
              (r = n[(t = a[s])]),
                (i = o[t]).setUpdateRange(r.min, r.max),
                i.flagUpdate();
          }),
          (s.Group.prototype.tick = function (e) {
            "use strict";
            var t = this.emitters,
              r = t.length,
            ...
            if (
              ...
              for (var o, n = 0; n < r; ++n)
                (o = t[n]).tick(i), this._updateBuffers(o);
              if (!0 === this._attributesNeedDynamicReset) {
                for (n = this.attributeCount - 1; n >= 0; --n)
                  s[a[n]].resetDynamic();
                this._attributesNeedDynamicReset = !1;
              }
              if (!0 === this._attributesNeedRefresh) {
                for (n = this.attributeCount - 1; n >= 0; --n)
                  s[a[n]].forceUpdateAll();
                (this._attributesNeedRefresh = !1),
          ...
          (s.Emitter = function (e) {
            "use strict";
            var t = s.utils,
              r = t.types,
              i = s.valueOverLifetimeLength;
            for (var a in (((e = t.ensureTypedArg(e, r.OBJECT, {})).position =
              t.ensureTypedArg(e.position, r.OBJECT, {})),
          ...
          (s.Emitter.constructor = s.Emitter),
          (s.Emitter.prototype._createGetterSetters = function (e, t) {
            "use strict";
            var r = this;
            for (var i in e)
                  ...
                  set: (function (e) {
                    return function (i) {
                      ...
                      "_rotationCenter" === e
                        ...
                        (this[e] = i),
                        Array.isArray(o) &&
                          s.utils.ensureValueOverLifetimeCompliance(r[t], n, n);
                    };
                  })(i),
                });
              }
          }),
          (s.Emitter.prototype._setBufferUpdateRanges = function (e) {
            "use strict";
          ...
          (s.Emitter.prototype._calculatePPSValue = function (e) {
            "use strict";
          ...
          (s.Emitter.prototype._setAttributeOffset = function (e) {
            (this.attributeOffset = e),
              (this.activationIndex = e),
              (this.activationEnd = e + this.particleCount);
          }),
          (s.Emitter.prototype._assignValue = function (e, t) {
            "use strict";
            switch (e) {
              case "position":
          ...
          (s.Emitter.prototype._assignPositionValue = function (e) {
            "use strict";
            var t = s.distributions,
              r = s.utils,
              i = this.position,
          ...
          (s.Emitter.prototype._assignForceValue = function (e, t) {
            "use strict";
            var r,
              i,
              a,
            ...
            switch (p._distribution) {
              case u.BOX:
                ...
                break;
              case u.SPHERE:
                (i = (r = this.attributes.position.typedArray.array)[
                  (n = 3 * e)
                ]),
                  (a = r[n + 1]),
                  (o = r[n + 2]),
            ...
            if ("acceleration" === t) {
              ...
              this.attributes.acceleration.typedArray.array[4 * e + 3] = h;
            }
          }),
          (s.Emitter.prototype._assignAbsLifetimeValue = function (e, t) {
            "use strict";
            var r,
              i = this.attributes[t].typedArray,
              a = this[t],
              o = s.utils;
            o.arrayValuesAreEqual(a._value) && o.arrayValuesAreEqual(a._spread)
              ? ((r = Math.abs(o.randomFloat(a._value[0], a._spread[0]))),
                i.setVec4Components(e, r, r, r, r))
              : i.setVec4Components(
                  e,
                  Math.abs(o.randomFloat(a._value[0], a._spread[0])),
                  Math.abs(o.randomFloat(a._value[1], a._spread[1])),
                  Math.abs(o.randomFloat(a._value[2], a._spread[2])),
                  Math.abs(o.randomFloat(a._value[3], a._spread[3]))
                );
          }),
          (s.Emitter.prototype._assignAngleValue = function (e) {
            "use strict";
            var t,
          ...
          (s.Emitter.prototype._assignParamsValue = function (e) {
            "use strict";
            this.attributes.params.typedArray.setVec4Components(
              ...
              0,
              Math.abs(
                s.utils.randomFloat(this.maxAge._value, this.maxAge._spread)
              ),
              s.utils.randomFloat(this.wiggle._value, this.wiggle._spread)
            );
          }),
          (s.Emitter.prototype._assignRotationValue = function (e) {
            "use strict";
            this.attributes.rotation.typedArray.setVec3Components(
              e,
              s.utils.getPackedRotationAxis(
                this.rotation._axis,
          ...
          (s.Emitter.prototype._assignColorValue = function (e) {
            "use strict";
            s.utils.randomColorAsHex(
          ...
          (s.Emitter.prototype._resetParticle = function (e) {
            "use strict";
            for (
              var t,
                r,
              ...
              (r = a[(t = o[n])]),
                (!0 !== i[t] && !0 !== r) ||
                  ...
                  !0 === r && s[t] === this.particleCount
                    ? ((a[t] = !1), (s[t] = 0))
                    : 1 == r && ++s[t]);
          }),
          (s.Emitter.prototype._updateAttributeUpdateRange = function (e, t) {
            "use strict";
          ...
          (s.Emitter.prototype._resetBufferRanges = function () {
            ...
            for (
              ...
              (t[(e = r[i])].min = Number.POSITIVE_INFINITY),
          ...
          (s.Emitter.prototype._checkParticleAges = function (e, t, r, i) {
            "use strict";
            for (var a, s, o, n, u = t - 1; u >= e; --u)
              0 !== (n = r[(a = 4 * u)]) &&
                ((o = r[a + 1]),
                (s = r[a + 2]),
                1 === this.direction
                  ? (o += i) >= s &&
                    ((o = 0), (n = 0), this._decrementParticleCount())
                  : (o -= i) <= 0 &&
                    ((o = s), (n = 0), this._decrementParticleCount()),
                (r[a] = n),
                (r[a + 1] = o),
                this._updateAttributeUpdateRange("params", u));
          }),
          (s.Emitter.prototype._activateParticles = function (e, t, r, i) {
            "use strict";
            for (var a, s, o = this.direction, n = e; n < t; ++n)
              (0 != r[(a = 4 * n)] && 1 !== this.particleCount) ||
          ...
          (s.Emitter.prototype.tick = function (e) {
            "use strict";
            if (!this.isStatic) {
              ...
              if (
                ...
                var o = 1 === this.particleCount ? s : 0 | s,
                  ...
                  l = u > 0 ? e / u : 0;
                this._activateParticles(o, n, i, l),
          ...
          (s.Emitter.prototype.reset = function (e) {
            "use strict";
            if (((this.age = 0), (this.alive = !1), !0 === e)) {
              for (
                var t,
                  ...
                  a = this.paramsArray,
                  s = this.attributes.params.bufferAttribute,
                  o = i - 1;
                o >= r;
                --o
              )
                (a[(t = 4 * o)] = 0), (a[t + 1] = 0);
              (s.updateRange.offset = 0),
                (s.updateRange.count = -1),
                (s.needsUpdate = !0);
            }
            return this;
          }),
  ...
  (() => {
    ...
    AFRAME.registerComponent("particle-system", {
      schema: {
        ...
        type: { type: "number", default: e.distributions.BOX },
        ...
        texture: {
          type: "asset",
          default:
            "https://cdn.rawgit.com/c-frame/aframe-particle-system-component/master/dist/images/star2.png",
        },
      ...
      init: function () {
        (this.presets = {}),
          (this.presets.dust = {
            ...
            particleCount: 100,
            texture:
              "https://cdn.rawgit.com/c-frame/aframe-particle-system-component/master/dist/images/smokeparticle.png",
          }),
          (this.presets.snow = {
            maxAge: 20,
            positionSpread: { x: 100, y: 100, z: 100 },
          ...
          (this.presets.rain = {
            ...
            size: [0.4],
            texture:
              "https://cdn.rawgit.com/c-frame/aframe-particle-system-component/master/dist/images/raindrop.png",
          });
      },
      update: function (e) {
        for (var t in (this.particleGroup &&
          this.el.removeObject3D("particle-system"),
        (this.preset = this.presets[this.data.preset] || {}),
        this.data))
          this.data[t] = this.applyPreset(t);
      ...
      initParticleSystem: function (t) {
        var r = new THREE.TextureLoader().load(
          t.texture,
          function (e) {
            return e;
          },
        ...
        this.particleGroup = new e.Group({
          texture: { value: r },
          maxParticleCount: t.maxParticleCount,
          blending: t.blending,
        });
        var i = new e.Emitter({
          ...
          rotation: {
            ...
            angleSpread: t.rotationAngleSpread,
            static: !0,
          },
          acceleration: {
            value: new THREE.Vector3(
              t.accelerationValue.x,
              t.accelerationValue.y,
              t.accelerationValue.z
            ),
            spread: new THREE.Vector3(
              t.accelerationSpread.x,
              t.accelerationSpread.y,
              t.accelerationSpread.z
            ),
          },
          velocity: {
            value: new THREE.Vector3(
          ...
          drag: {
            ...
            randomise: t.dragRandomise,
          },
          color: {
            value: t.color.map(function (e) {
              return new THREE.Color(e);
            }),
          },
          size: {
            value: t.size.map(function (e) {
              return parseFloat(e);
            }),
            spread: t.sizeSpread.map(function (e) {
              return parseFloat(e);
            }),
          },
          ...
          duration: t.duration,
          opacity: {
            value: t.opacity.map(function (e) {
              return parseFloat(e);
            }),
            spread: t.opacitySpread.map(function (e) {
              return parseFloat(e);
            }),
          },
          particleCount: t.particleCount,
        });
        this.particleGroup.addEmitter(i),
